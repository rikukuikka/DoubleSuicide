...
UPDATE_PLAYERS:
    ...
    LD      A, (P1_X) : LD B, A : LD C, E : CALL IS_WALL : JR NZ, .p1nu
    LD      A, (P1_X) : ADD A, 7 : LD B, A : LD C, E : CALL IS_WALL : JR NZ, .p1nu
    LD      A, E : LD (P1_Y), A : LD A, DIR_UP : LD (P1_DIR), A
.p1nu:
    LD      A, (P1_INPUT) : AND IN_DOWN : JR Z, .p1nd
    LD      A, (P1_Y) : ADD A, SPEED : CP 176 : JR NC, .p1nd : LD E, A
    LD      A, (P1_X) : LD B, A : LD A, E : ADD A, 7 : LD C, A : CALL IS_WALL : JR NZ, .p1nd
    LD      A, (P1_X) : ADD A, 7 : LD B, A : LD A, E : ADD A, 7 : LD C, A : CALL IS_WALL : JR NZ, .p1nd
    LD      A, E : LD (P1_Y), A : LD A, DIR_DOWN : LD (P1_DIR), A
.p1nd:
    LD      A, (P1_INPUT) : AND IN_LEFT : JR Z, .p1nl
    LD      A, (P1_X) : SUB SPEED : JR C, .p1nl : LD E, A
    LD      B, E : LD A, (P1_Y) : ADD A, 1 : LD C, A : CALL IS_WALL : JR NZ, .p1nl
    LD      B, E : LD A, (P1_Y) : ADD A, 6 : LD C, A : CALL IS_WALL : JR NZ, .p1nl
    LD      A, E : LD (P1_X), A : LD A, DIR_LEFT : LD (P1_DIR), A
.p1nl:
    LD      A, (P1_INPUT) : AND IN_RIGHT : JR Z, .p1nr
    LD      A, (P1_X) : ADD A, SPEED : CP 249 : JR NC, .p1nr : LD E, A
    LD      A, E : ADD A, 7 : LD B, A : LD A, (P1_Y) : ADD A, 1 : LD C, A : CALL IS_WALL : JR NZ, .p1nr
    LD      A, E : ADD A, 7 : LD B, A : LD A, (P1_Y) : ADD A, 6 : LD C, A : CALL IS_WALL : JR NZ, .p1nr
    LD      A, E : LD (P1_X), A : LD A, DIR_RIGHT : LD (P1_DIR), A
.p1nr:
    CALL    DRAW_P1
    ...
    LD      A, (P2_X) : LD B, A : LD C, E : CALL IS_WALL : JR NZ, .p2nu
    LD      A, (P2_X) : ADD A, 7 : LD B, A : LD C, E : CALL IS_WALL : JR NZ, .p2nu
    LD      A, E : LD (P2_Y), A : LD A, DIR_UP : LD (P2_DIR), A
.p2nu:
    LD      A, (P2_INPUT) : AND IN_DOWN : JR Z, .p2nd
    LD      A, (P2_Y) : ADD A, SPEED : CP 176 : JR NC, .p2nd : LD E, A
    LD      A, (P2_X) : LD B, A : LD A, E : ADD A, 7 : LD C, A : CALL IS_WALL : JR NZ, .p2nd
    LD      A, (P2_X) : ADD A, 7 : LD B, A : LD A, E : ADD A, 7 : LD C, A : CALL IS_WALL : JR NZ, .p2nd
    LD      A, E : LD (P2_Y), A : LD A, DIR_DOWN : LD (P2_DIR), A
.p2nd:
    LD      A, (P2_INPUT) : AND IN_LEFT : JR Z, .p2nl
    LD      A, (P2_X) : SUB SPEED : JR C, .p2nl : LD E, A
    LD      B, E : LD A, (P2_Y) : ADD A, 1 : LD C, A : CALL IS_WALL : JR NZ, .p2nl
    LD      B, E : LD A, (P2_Y) : ADD A, 6 : LD C, A : CALL IS_WALL : JR NZ, .p2nl
    LD      A, E : LD (P2_X), A : LD A, DIR_LEFT : LD (P2_DIR), A
.p2nl:
    LD      A, (P2_INPUT) : AND IN_RIGHT : JR Z, .p2nr
    LD      A, (P2_X) : ADD A, SPEED : CP 249 : JR NC, .p2nr : LD E, A
    LD      A, E : ADD A, 7 : LD B, A : LD A, (P2_Y) : ADD A, 1 : LD C, A : CALL IS_WALL : JR NZ, .p2nr
    LD      A, E : ADD A, 7 : LD B, A : LD A, (P2_Y) : ADD A, 6 : LD C, A : CALL IS_WALL : JR NZ, .p2nr
    LD      A, E : LD (P2_X), A : LD A, DIR_RIGHT : LD (P2_DIR), A
.p2nr:
    CALL    DRAW_P2
    RET
